...
class OneFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        view.findViewById<TextView>(R.id.one).setOnClickListener {
            ...
            val bundle = bundleOf("amount" to "45")
            it.findNavController().navigate(R.id.action_oneFragment_to_twoFragment,bundle)
        }

        view.findViewById<TextView>(R.id.two).setOnClickListener {
